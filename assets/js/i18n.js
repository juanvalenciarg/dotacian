...
const I18N = {
  es: {
    ...
    // Area options (shared)
    'area.direccion': 'Dirección / Gerencia General',
    'area.administracion': 'Administración y Finanzas',
    'area.rrhh': 'Recursos Humanos',
    'area.legal': 'Legal / Cumplimiento',
    'area.ventas': 'Ventas / Comercial',
    'area.marketing': 'Marketing',
    'area.atencion': 'Atención al Cliente / Servicio',
    'area.operaciones': 'Operaciones',
    'area.produccion': 'Producción / Manufactura',
    'area.cocina': 'Cocina / Alimentos y Bebidas',
    'area.calidad': 'Calidad',
    'area.mantenimiento': 'Mantenimiento',
    'area.logistica': 'Logística y Distribución',
    'area.compras': 'Compras / Abastecimiento',
    'area.bodega': 'Bodega / Almacén',
    'area.seguridad': 'Seguridad y Vigilancia',
    'area.sst': 'Salud y Seguridad Ocupacional',
    'area.limpieza': 'Limpieza y Aseo',
    'area.recepcion': 'Recepción / Front Desk',
    'area.salud': 'Salud / Clínico',
    'area.construccion': 'Construcción / Obra',
    'area.ti': 'Tecnología / TI',
    ...
    'item.tablet': 'Tablet',
    'item.overol': 'Overol',
    'item.filipina': 'Filipina',
    'item.gorro': 'Gorro',
    'item.zapatosSeguridad': 'Zapatos de seguridad',
    'item.equipoAlturas': 'Equipo para trabajo en alturas',
    'item.gafasProteccion': 'Gafas de protección',
    'item.guantesSeguridad': 'Guantes de seguridad',
    'item.chalecoReflectivo': 'Chaleco reflectivo',
    'item.proteccionAuditiva': 'Protección auditiva',
    'item.respirador': 'Respirador/Mascarilla',
    'item.lamparaCasco': 'Lámpara de casco',
    ...
    'newRole.assetTypesLabel': 'Activos a entregar',
  ...
  en: {
    ...
    'area.administracion': 'Administration & Finance',
    'area.rrhh': 'Human Resources',
    'area.legal': 'Legal / Compliance',
    'area.ventas': 'Sales',
    'area.marketing': 'Marketing',
    'area.atencion': 'Customer Service',
    'area.operaciones': 'Operations',
    'area.produccion': 'Production / Manufacturing',
    'area.cocina': 'Kitchen / Food & Beverage',
    'area.calidad': 'Quality',
    'area.mantenimiento': 'Maintenance',
    'area.logistica': 'Logistics & Distribution',
    'area.compras': 'Purchasing / Procurement',
    'area.bodega': 'Warehouse',
    'area.seguridad': 'Security',
    'area.sst': 'Occupational Health & Safety',
    'area.limpieza': 'Cleaning',
    'area.recepcion': 'Front Desk / Reception',
    'area.salud': 'Healthcare / Clinical',
    'area.construccion': 'Construction / Site',
    'area.ti': 'IT',
    ...
    'item.celular': 'Cell phone',
    'item.tablet': 'Tablet',
    'item.overol': 'Coveralls',
    'item.filipina': 'Chef coat',
    'item.gorro': 'Cap',
    'item.zapatosSeguridad': 'Safety shoes',
    'item.equipoAlturas': 'Fall protection equipment',
    'item.gafasProteccion': 'Safety glasses',
    'item.guantesSeguridad': 'Safety gloves',
    'item.chalecoReflectivo': 'Reflective vest',
    'item.proteccionAuditiva': 'Hearing protection',
    'item.respirador': 'Respirator/Mask',
    'item.lamparaCasco': 'Helmet lamp',
    'item.googleWorkspace': 'Google Workspace',
    'item.microsoft365': 'Microsoft 365',
    'item.crm': 'CRM',
    'item.erp': 'ERP',
    ...
    'newRole.assetTypesLabel': 'Assets to provide',
